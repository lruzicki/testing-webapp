...
module.exports = class TestDataAggregation {
  ...
  getTestCasesRuntimeInfo() {
    ...
    this.data.testCasesFinished = this.getGroupedTestCaseAttributeMap(this.testCaseInfo, PropertyNames.TEST_CASE_FINISHED, 'testCaseStartedId');
  }
